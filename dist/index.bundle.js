...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nconst getData = async () => {\n  try {\n    const response = await fetch('https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/C7f1ZyFASEaPz8JYF43m/scores');\n    const data = await response.json();\n    return data;\n  } catch (error) {\n    return error.message;\n  }\n};\n\nconst refresh = async () => {\n  const scoreCon = document.querySelector('.score-box ul');\n  const data = await getData();\n\n  const { result } = data;\n\n  result.forEach((item) => {\n    scoreCon.innerHTML += `<li class=\"score-item\">${item.user}: ${item.score}</li>`;\n  });\n};\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (refresh);\n\n//# sourceURL=webpack://leaderboard/./src/data.js?");
